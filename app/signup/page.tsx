...
import { Newspaper, User, Mail, Lock, Loader2 } from 'lucide-react'
...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center px-4 py-8">
      <Toaster richColors />
        ...
        <Card className="border border-slate-200 dark:border-slate-800 shadow-xl">
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">Create your account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">At least 6 characters</p>
              </div>
